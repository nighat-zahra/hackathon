    ...
    return(
        <main className=" max-w-screen-2xl mx-auto">
             ...
             <h1 className="text-2xl">All Reviws</h1>
               ...
               <Button className="hidden md:block bg-black w-[100px] h-[50px]  text-white absolute">Latest</Button>
               <Button  className="hidden md:block bg-black w-[150px] h-[50px] text-white relative">Write Now Review</Button>
               </div>
             </div>
             {/* container */}
             <div>
